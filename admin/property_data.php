...
$sql = "SELECT * FROM inquiries WHERE DATE(created_at) BETWEEN ? AND ? ORDER BY created_at DESC";
...
if (isset($_POST['generate_csv']) || isset($_POST['generate_pdf'])) {
    ...
    if (isset($_POST['generate_csv'])) {
        ...
        fputcsv($output, ['Sr.No', 'Date', 'Inquiries Name', 'Email', 'Contact', 'Message', 'Slug']);
    ...
    if (isset($_POST['generate_pdf'])) {
        ...
        $columns = ['Sr.No', 'Date', 'Inquiries Name', 'Email', 'Contact', 'Message', 'Slug'];
        $widths = [20, 20, 100, 100, 30, 100, 30];
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $pdf->Cell(100, 10, $row['full_name'], 1);
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                Inquiries From Property
                    <div class="page-title-subheading">
                        <a href="index.php">Dashboard</a> /
                        <a href="property_data.php">Inquiries From Property</a>
                    </div>
                </div>
