...
if (isset($_POST['submit'])) {
    ...
    if (!in_array(strtolower($file_extension), $allowed_extensions)) {
        ...
        $sql = "INSERT INTO `whyinvest`(`image`, `title`, `status`,`property_type`) VALUES ('$upload_file', '$title', '$status','$property_type')";
...
<div class="app-main__inner">
    ...
    <div class="container">
        <form action="whyinvest-add.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
