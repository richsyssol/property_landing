...
<div class="app-main__inner">
    ...
    <div>
        ...
        <div>
            <a href="whyus-add.php" class="btn btn-success">Add Why Us</a>
        </div>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp; / &nbsp;
                                <a href="whyus-edit.php?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                        </tr>
                    <?php 
                    }
